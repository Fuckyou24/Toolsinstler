clear
	...
	echo
	echo $pur"==================="$cy" ============================="
	echo $i"##"$me"  AUTHOR  : ./Tn.1KEH🔱🌹"$i"                      ##"
	echo $i"##"$pu"  WhatsApp:  0852-4045-7692"$i"    ##"
	echo $i"##"$me"  Instagram :  @maula_az"$i"                ##"
	echo $i"##"$pu"  Contact Me :  maulanamaull228@gmail.com"$i"                                 ##"
	echo $pur"==================="$cy" ============================="
	echo $i"[" $me" INI TOOLS BAYAR BULAN DEPAN", $bi"DILARANG RECOD AUTO HACK LU COK.." $i"]"
	echo $i"[" $me" HACKER GANAS" $pu"!!!" $i"]"
	echo #pu"~~~~~~~~~~~~~~~~~~~~~"$me"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	echo
	echo $cy"./Tn.1KEH🔱🌹 Menu:"
	echo
	echo $me"[==============="$pu"===============]"
	...
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"11"$bi"]"$i" 📷Insta_Hack(RootSYG)"
	echo $me"[==============="$pu"===============]"
	...
	echo $me"[==============="$pu"===============]"
	echo $me"["$me"21"$pu"]"$i" 😋Hack Twitter (RootSYG)"
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"22"$bi"]"$i" 🎃Hack Gmail(RootSYG)"
	echo $me"[==============="$pu"===============]"
	echo $bi"["$pu"23"$bi"]"$i" 😃Youtube AutoView (RootSYG)"
	echo $me"[==============="$pu"===============]"
	...
	echo $me"[==============="$pu"===============]"
	echo $me"["$pu"30"$me"]"$i" 🤫BRUTEFORCE FB(RootSYG)"
	echo $me"[==============="$pu"===============]"
	...
	echo
	echo $pur"./Tn.1KEH🔱🌹["$pur"Tentukan pilihan kamu Sekarang"$pur"]"
	read -p"./Tn.1KEH🔱🌹" pil
...
if [ $pil = 74 ]
	...
	cd Enigma
	echo "\033[33;1Kunjungi Youtube Saya:" "\033[36;1m https://m.youtube.com/channel/UCzsBNe-gFuzvqoZK1IdILXg"
	sleep 5
	python2 enigma.py
	fi
	...
	sleep 2
	echo $ku"WAName   :"$i" ./Tn.1KEH🔱🌹"
	echo $ku"Gmail  :"$i" maulanamaull228@gmail.com"
	echo $ku"WhatsApp :"$i" 085240457692"
	sleep 2
	echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
	sleep 2
	echo $pur"JANGAN LUPA TERSENYUM HARI INI KAWAN :)"
	exit
	fi
